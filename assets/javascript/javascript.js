$(document).ready(function () {
    ...
    var myButtons = ["Wolf", "Snake", "Dog", "Cat", "Armadillo", "Stingray", "Shark", "Pigeon", "Hippo", "Lion", "Monkey", "Giraffe"];

    // re-render function
    function displayGifInfo() {

        var gifSearch = $(this).attr("data-name");
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gifSearch + "&api_key=gvl45davu8qEbFCVDLB3NghOcK3R8wYJ&limit=10";
